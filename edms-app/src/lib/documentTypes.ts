...
export const DOCUMENT_TYPE_LABELS: Record<DocumentType, string> = {
  ...
  'Formulir Kerja': 'Formulir Mutu Standar (Level 4 — FR.01.04)',
  ...
  'Formulir Kerja': [
    {
      ...
      hint: 'Nama formulir, kode formulir, bidang penerbit, dan nomor revisi.',
      defaultHtml: '<p><strong>Nama Formulir:</strong> Formulir Rekaman Mutu Kerja Standar<br><strong>Kode Formulir:</strong> FR.UPS.XXXX.XX.XX-00<br><strong>Bidang:</strong> Pengendalian Mutu & Sertifikasi</p>'
    },
    {
      key: 'petunjuk_pengisian',
      label: '2. Petunjuk Pengisian',
      hint: 'Panduan tata cara pengisian kolom bagi pengguna formulir.',
      defaultHtml: '<p>Isilah kolom-kolom berikut dengan huruf kapital secara jelas. Berikan tanda centang (✓) pada opsi yang sesuai.</p>'
    },
    {
      key: 'isian_formulir',
      label: '3. Format Isian / Matriks Formulir',
      hint: 'Bentuk tabel, format isian data, checklist, dan kolom tanda tangan.',
      defaultHtml: '<table border="1" cellpadding="6" style="width:100%; border-collapse:collapse;"><thead><tr style="background:#f1f5f9;"><th>No</th><th>Item Verifikasi</th><th>Standar / Kriteria</th><th>Hasil (Ya / Tidak)</th><th>Keterangan</th></tr></thead><tbody><tr><td>1</td><td>Kelengkapan Dokumen Portofolio</td><td>Lengkap & Sah</td><td>Ya</td><td>Sesuai persyaratan</td></tr><tr><td>2</td><td>Kesesuaian Data Identitas</td><td>KTP / NIP Valid</td><td>Ya</td><td>Terverifikasi</td></tr></tbody></table>'
    }
  ],
